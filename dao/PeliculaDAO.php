...
class PeliculaDAO
{
    ...
    function save($pelicula)
    {
        ...
        try {
            ...
            $sql = "INSERT INTO pelicula (genero, titulo, sinopsis, duracion, clasificacion, imagen_url, estreno)" .
                " VALUES (:genero, :titulo, :sinopsis, :duracion, :clasificacion, :imagen_url, :estreno)";
            $stmt = $db->prepare($sql);
    ...
    function actualizar($pelicula)
    {
        ...
        try {
            ...
            $sql = "UPDATE pelicula SET genero = :genero, titulo = :titulo, sinopsis = :sinopsis, duracion = :duracion, clasificacion = :clasificacion WHERE id_pelicula = :id_pelicula";
