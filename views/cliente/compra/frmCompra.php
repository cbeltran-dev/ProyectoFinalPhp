                ...
                <table>
                    ...
                    foreach ($horario as $funcion)
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="frmRealizarCompra.php?id_usuario=<?php echo $id_usuario; ?>&id_pelicula=<?php echo $id_pelicula; ?>&id_funcion=<?php echo $funcion['id_funcion']; ?>&tipo_sala=<?php echo $funcion['tipo_sala']; ?>" class="boton-comprar">Comprar</a></td>
                        </tr>
                        <?php
                    }
                    ?>
